...
plugins:
	...
	make EE_DIR=$(EE_DIR) -C hba_servo/sw all
...
clean:
	...
	make EE_DIR=$(EE_DIR) -C hba_servo/sw clean
...
plugins-install:
	...
	make INST_LIB_DIR=$(INST_LIB_DIR) EE_DIR=$(EE_DIR) -C hba_servo/sw install
...
plugins-uninstall:
	...
	make INST_LIB_DIR=$(INST_LIB_DIR) EE_DIR=$(EE_DIR) -C hba_servo/sw uninstall
